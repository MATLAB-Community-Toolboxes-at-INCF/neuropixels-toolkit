...
for curr = run_specs
    ...
    for i=1:length(prob_list)
        ...
        % Run CatGT
        catGT_input_json{i} = fullfile(json_directory, session_id, prb, '_CatGT', '-input.json');
        catGT_output_json{i} = fullfile(json_directory, session_id, prb, '_CatGT', '-output.json');
    end
