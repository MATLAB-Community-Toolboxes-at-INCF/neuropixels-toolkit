classdef CatGT < npxtoolkit.tasks.TaskBase
    ...
    methods
        ...
        function execute(obj)
            ...
            prb = '0';
            taskIdx = 1; % first task in taskQueue

            runFolderName = strcat(config.RunName, '_g', config.GateIdx);
            probFolderName = strcat(runFolderName, '_imec', prb); % TODO-probe #
            ...
            info = py.py_modules.caller.createInputJson(...
                pyargs(...
                    ...
                    'kilosort_output_directory', config.DataDir,...
                    'spikeGLX_data', true,...
                    ...
                    'extracted_data_directory', config.DataDir...
                )...
            );
        end
    end
